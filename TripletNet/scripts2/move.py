...
fec_path = "/data1/Alan/GoogleDataset-Default/fec_train.csv"
train_path = "/data1/Alan/GoogleDataset-Default/train.csv"
valid_path = "/data1/Alan/GoogleDataset-Default/valid.csv"

split_df = pd.read_csv("/data1/Alan/GoogleDataset-Default/split.csv")
